...
class CubicLineMarker implements IMarker {
  ...
  CubicLineMarker({Color firstTextColor, Color secondTextColor, Color backgroundColor, double fontSize})
  ...
  void draw(Canvas canvas, double posX, double posY) {
    TextPainter painter = PainterUtils.create(null, "${_entry.y.toInt()}점", _secondTextColor, _fontSize);
    Paint paint = Paint()
      ..color = _backgroundColor
      ..strokeWidth = 2
      ..isAntiAlias = true
