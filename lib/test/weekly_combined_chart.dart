...
class WeeklyCombinedChart extends StatefulWidget {
  static const routeName = "/test/weekly_combined";

  @override
  State<StatefulWidget> createState() {
    return WeeklyCombinedChartState();
  }
}

class WeeklyCombinedChartState extends State<WeeklyCombinedChart> {
...
final List<String> days = List()..add("월")..add("화")..add("수")..add("목")..add("금")..add("토")..add("일");
