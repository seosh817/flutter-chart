...
class CubicLineChart extends StatefulWidget {
  final DateTime startTime;
  final DateTime lastTime;

  static const routeName = "/test/cubic_line";

  const CubicLineChart({Key key, this.startTime, this.lastTime})
      : super(key: key);

  @override
  State<StatefulWidget> createState() => _CubicLineChartState();
}

class _CubicLineChartState extends State<CubicLineChart> {
