...
class CombinedTest extends StatefulWidget {
  static const routeName = "/test/combined_test";

  @override
  State<StatefulWidget> createState() {
    return CombinedTestState();
  }
}

class CombinedTestState extends State<CombinedTest> {
  ...
  BarData generateBarData() {
    ...
    //highlight
    set1.setHighLightColor(Colours.mango);
...
final List<String> months = List()..add("1주")..add("2주")..add("3주")..add("4주");
